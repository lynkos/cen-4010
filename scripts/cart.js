...
function displayCart() {
  ...
  for(var i in cartArray) {
    output += "<tr>"
      ...
      + "<input type='number' min='0' style='text-align: center;' class='item-count form-control' data-name='" + cartArray[i].name + "' value='" + cartArray[i].count + "'>"
      ...
      + "<td style='vertical-align: middle;'><button class='delete-item btn btn-danger' data-name=" + cartArray[i].name + "><i class='fas fa-x' aria-hidden='true'></i></button></td>"
      + " = " 
